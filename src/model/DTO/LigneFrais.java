...
public class LigneFrais {
	...
	public LigneFrais(int unIdFiche, String unIdTypeFrais, int uneQuantiteDeclaree , String unLibelle , float unTarif, int uneQuantiteValidee)
    {
    	idFiche = unIdFiche;
        ...
        quantiteValidee = uneQuantiteValidee;
    }
